          ...
          <div className="flex items-center justify-center mx-2">
            <div className="bg-gray-200 p-4 rounded shadow-xl text-center">
              <img
                ...
                alt="Error"
              />
              <h2 className="text-lg font-bold mb-2">ACCES LOCATIE</h2>
              <p>
                Pentru a putea intra pe pagina avem nevoie de acces la locatie.
              </p>
            </div>
          </div>
        ) : (
      ...
      <div className="flex items-center justify-center mx-2">
        <div className="bg-gray-200 p-4 rounded shadow-xl text-center">
          <img
            ...
            alt="Error"
          />
          <h2 className="text-lg font-bold mb-2">LOCATIE BLOCATA</h2>
          <p>Permite accesul la locatie pentru a putea intra pe pagina.</p>
