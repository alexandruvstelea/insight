...
async def get_faculties(
    ...
    response = await FacultyService(session).get_faculties()
    return response
...
async def get_faculties_by_id(
    ...
    response = await FacultyService(session).get_faculty_by_id(id)
    return response
...
async def add_faculty(
    ...
    response = await FacultyService(session).add_faculty(faculty_data)
    return response
...
async def update_faculty(
    ...
    response = await FacultyService(session).update_faculty(id, new_faculty_data)
    return response
...
async def delete_faculty(id: int, session: AsyncSession = Depends(get_session)) -> str:
    response = await FacultyService(session).delete_faculty(id)
    return response
