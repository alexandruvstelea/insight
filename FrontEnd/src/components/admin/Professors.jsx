...
export default function Professors({ professors, fetchProfessors }) {
  ...
  const table = useMaterialReactTable(tableConfig(columns, professors, 'profesor', handleCreateProfessor, handleSaveProfessor, 'professors', fetchProfessors));

  return (
    <>

      <div className="table">
        <DialogTitle sx={{ textAlign: 'center' }} variant="h3">Tabel Profesori</DialogTitle>
